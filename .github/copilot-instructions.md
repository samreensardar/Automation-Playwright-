...
- If a required file does not exist, create it in JavaScript
- Use ESM imports where already used in the project
...
- Import test from `src/fixtures/base.js`, never from `@playwright/test` directly unless no fixture file exists
